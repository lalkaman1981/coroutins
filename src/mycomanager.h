...
public:
  /**
   * This constructor automatically assigns a default priority to each created
   * task.
   */
   ...
   * For example, if the current priorities are <1, 2, 3> and a new task is
   * added, the resulting priorities will be <1, 2, 3, 4>.
   */
